...
class CreateEquiAtelierArticlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('equi_atelier_articles', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('equi_atelier_articles');
    }
}
