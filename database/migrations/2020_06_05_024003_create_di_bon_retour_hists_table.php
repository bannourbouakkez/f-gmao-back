...
class CreateDiBonRetourHistsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('di_bon_retour_hists', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->foreign('retour_id')->references('RetourID')->on('di_bon_retours');
    ...
    {
        Schema::dropIfExists('di_bon_retour_hists');
    }
}
